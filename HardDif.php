...
<html>
    ...
    <body style ="font-family: sans-serif; background: url(https://static.miraheze.org/allthetropeswiki/5/57/6a00d8341c68f553ef01310ff3f483970c-800wi_7998.jpg); background-size: 100%;">
        <header>
                ...
                <div class="collapse navbar-collapse" id="navbarColor02">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link" href="HardDif.php">(I dont want to play anymore) <span class="sr-only">(current)</span></a>
                    </li>
                  </ul>
        ...
        <!-- Game development -->
           <h1> Read My Mind</h1>
           <h2>Current mode: <strong>I dont want to play anymore</strong> </h2><br>

           <h3>Assignment:</h3>
            <p><strong>I am thinking of a number between 1 and 100</strong></p>
            <p><strong>Enter your guess below to see if you can read my mind!</strong></p>
             <form action="" method="POST">
               <label for="guess" >Enter your guess:</label>
                    <input type="number"  id= "guess" name="num" min="1" max="100" required="required" autofocus>
